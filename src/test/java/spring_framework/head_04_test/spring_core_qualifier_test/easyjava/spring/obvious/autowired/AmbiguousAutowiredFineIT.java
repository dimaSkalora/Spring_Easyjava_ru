package spring_framework.head_04_test.spring_core_qualifier_test.easyjava.spring.obvious.autowired;
...
import spring_framework.head_04.spring_core_qualifier.easyjava.spring.qualifier.autowired.AmbiguousAutowiredFine;
...
public class AmbiguousAutowiredFineIT {
    ...
    @Configuration
    @ComponentScan("spring_framework.head_04.spring_core_qualifier.easyjava.spring.qualifier.autowired")
