package spring_framework.head_04_test.spring_core_qualifier_test.easyjava.spring.named.resource;
...
import spring_framework.head_04.spring_core_qualifier.easyjava.spring.named.resource.AmbiguousResourceFine;
...
public class AmbiguousResourceFineIT {
    ...
    @Configuration
    @ComponentScan("spring_framework.head_04.spring_core_qualifier.easyjava.spring.named.resource")
