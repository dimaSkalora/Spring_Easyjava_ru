package spring_framework.head_04_test.spring_core_qualifier_test.easyjava.spring.list.inject;
...
import spring_framework.head_04.spring_core_qualifier.easyjava.spring.list.inject.AmbiguousInjectFine;
...
public class AmbiguousInjectFineIT {
    ...
    @Configuration
    @ComponentScan("spring_framework.head_04.spring_core_qualifier.easyjava.spring.list.inject")
