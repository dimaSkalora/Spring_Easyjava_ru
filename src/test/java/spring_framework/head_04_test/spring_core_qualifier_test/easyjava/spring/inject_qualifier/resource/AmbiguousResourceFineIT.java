package spring_framework.head_04_test.spring_core_qualifier_test.easyjava.spring.inject_qualifier.resource;
...
import spring_framework.head_04.spring_core_qualifier.easyjava.spring.inject_qualifier.resource.AmbiguousResourceFine;
...
public class AmbiguousResourceFineIT {
    ...
    @Configuration
    @ComponentScan("spring_framework.head_04.spring_core_qualifier.easyjava.spring.inject_qualifier.resource")
