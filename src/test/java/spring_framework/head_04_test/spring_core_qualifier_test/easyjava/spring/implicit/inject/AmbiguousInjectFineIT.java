package spring_framework.head_04_test.spring_core_qualifier_test.easyjava.spring.implicit.inject;
...
import spring_framework.head_04.spring_core_qualifier.easyjava.spring.implicit.inject.AmbiguousInjectFine;
...
public class AmbiguousInjectFineIT {
    ...
    @Configuration
    @ComponentScan("spring_framework.head_04.spring_core_qualifier.easyjava.spring.implicit.inject")
